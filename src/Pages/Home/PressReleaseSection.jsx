...
const InfoSection = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url('https://images.unsplash.com/photo-1603262110263-fb0112e7cc33?q=80&w=1600&auto=format&fit=crop&ixlib=rb-4.1.0')", // 👈 apna background image path yaha do
